...
public class BookSellerAgent extends Agent {
  ...
  **/
  //!!
  public void putForSale(String title, int initPrice, int minPrice, Date deadline, int pages) {
    addBehaviour(new PriceManager(this, title, initPrice, minPrice, deadline, pages));
  }

  private class PriceManager extends TickerBehaviour {
    private String title;
    private int minPrice, currentPrice, initPrice, deltaP, pages; //!!
    private long initTime, deadline, deltaT;

    private PriceManager(Agent a, String t, int ip, int mp, Date d, int pag) {
