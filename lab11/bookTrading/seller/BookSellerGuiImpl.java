...
public class BookSellerGuiImpl extends JFrame implements BookSellerGui {
	...
	private JTextField titleTF, desiredPriceTF, minPriceTF, deadlineTF, pagesTF; //!!
  ...
  public void setAgent(BookSellerAgent a) {
    ...
    pagesTF = new JTextField(64);
    pagesTF.setMinimumSize(new Dimension(70, 20));
    pagesTF.setPreferredSize(new Dimension(70, 20));
    ...
    gridBagConstraints.anchor = GridBagConstraints.NORTHWEST;
    gridBagConstraints.insets = new Insets(5, 3, 0, 3);
    rootPanel.add(pagesTF, gridBagConstraints);
							...
							// added by Symbios
					  		try {
								...
								if (minPrice <= desiredPrice) {
									...
									myAgent.putForSale(title, desiredPrice, minPrice, deadline, pages);
									notifyUser("PUT FOR SALE: "+title+" with " +pages+" pages and price between "+desiredPrice+" and "+minPrice+" by "+deadline); //!!!
								}
								else {
